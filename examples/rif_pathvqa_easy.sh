...
python3 -m verl.trainer.main \
    ...
    data.train_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v2/mllm_cl_pathvqa_solvable/train.parquet \
    data.val_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v2/mllm_cl_pathvqa_solvable/test.parquet \
    data.prompt_key=problem \
    data.image_key=images \
    worker.actor.model.model_path=${MODEL_PATH} \
    worker.reward.reward_function=./examples/reward_function/math.py:compute_score \
    trainer.project_name=rif_pathvqa_v2 \
    trainer.experiment_name=qwen2_5_7b_pathvqa_easy_24 \
