...
MODEL_PATH=/lustre/projects/med-multi-llm/haohan/EasyR1/checkpoints/easy_r1/qwen3_nocot_sci_02/global_step_36/actor/huggingface
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_nocot_text_03 \
