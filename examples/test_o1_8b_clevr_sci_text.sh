...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_8b_eval_sci \
...
python3 -m verl.trainer.main \
    ...
    worker.actor.model.model_path=${MODEL_PATH1} \
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.experiment_name=qwen3_8b_eval_text \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.experiment_name=qwen3_8b_clevr_sci_eval_clevr \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.experiment_name=qwen3_8b_clevr_sci_text_eval_clevr \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=image \
    worker.rollout.enforce_eager=false \
...
python3 -m verl.trainer.main \
    ...
    worker.actor.model.model_path=${MODEL_PATH3} \
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.experiment_name=qwen3_8b_clevr_sci_text_eval_sci \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
