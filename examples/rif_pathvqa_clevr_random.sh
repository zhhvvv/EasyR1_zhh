...
python3 -m verl.trainer.main \
    ...
    data.train_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v3/mllm_cl_clevr_random/train.parquet \
    data.val_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v3/mllm_cl_clevr_random/test.parquet \
    ...
    trainer.experiment_name=qwen2_5_7b_pathvqa_clevr_random_1 \
