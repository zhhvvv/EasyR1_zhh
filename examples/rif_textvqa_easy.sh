...
python3 -m verl.trainer.main \
    ...
    data.train_files=/lustre/projects/med-multi-llm/haohan/rif_dataset/mllm_cl_textvqa_solvable/train.parquet \
    data.val_files=/lustre/projects/med-multi-llm/haohan/rif_dataset/mllm_cl_textvqa_solvable/test.parquet \
    ...
    trainer.experiment_name=qwen2_5_7b_textvqa_easy \
