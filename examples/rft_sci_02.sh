...
MODEL_PATH=/lustre/projects/med-multi-llm/haohan/EasyR1/checkpoints/easy_r1/qwen3_nocot_clevr_01/global_step_45/actor/huggingface
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_nocot_clevr_sci_02 \
