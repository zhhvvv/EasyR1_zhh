...
python3 -m verl.trainer.main \
    ...
    data.train_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v2/mllm_cl_geo_unsolvable/train.parquet \
    data.val_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v2/mllm_cl_geo_unsolvable/test.parquet \
    data.prompt_key=problem \
    data.image_key=images \
    worker.actor.model.model_path=${MODEL_PATH} \
    worker.reward.reward_function=./examples/reward_function/math.py:compute_score \
    trainer.project_name=rif_geo \
    trainer.experiment_name=qwen2_5_7b_geo_hard_1 \
