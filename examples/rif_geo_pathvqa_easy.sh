...
MODEL_PATH=/lustre/projects/med-multi-llm/haohan/EasyR1/checkpoints/rif_geo/qwen2_5_7b_geo_easy_1/global_step_20/actor/huggingface

python3 -m verl.trainer.main \
    config=examples/config.yaml \
    data.train_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v1/mllm_cl_pathvqa_solvable/train.parquet \
    data.val_files=/lustre/projects/med-multi-llm/haohan/cl_rif_dataset_v1/mllm_cl_pathvqa_solvable/test.parquet \
