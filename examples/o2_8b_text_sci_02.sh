...
MODEL_PATH=/lustre/projects/med-multi-llm/haohan/EasyR1/checkpoints/o2_text_sci_clevr/qwen3_8b_nocot_text_01/global_step_67/actor/huggingface
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_8b_nocot_text_sci_02 \
