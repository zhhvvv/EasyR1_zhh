...
MODEL_PATH=/lustre/projects/med-multi-llm/haohan/models/Qwen2.5-VL-3B-Instruct  # replace it with your local file path
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_3b_nocot_clevr_01 \
