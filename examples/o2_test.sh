...
MODEL_PATH2=/lustre/projects/med-multi-llm/haohan/EasyR1/checkpoints/o2_text_sci_clevr/qwen2_5_3b_nocot_text_sci_02/global_step_36/actor/huggingface
...
MODEL_PATH4=/lustre/projects/med-multi-llm/haohan/EasyR1/checkpoints/o2_text_sci_clevr/qwen3_8b_nocot_text_sci_02/global_step_36/actor/huggingface
...
python3 -m verl.trainer.main \
    ...
    trainer.project_name=o2_text_sci_clevr \
    trainer.experiment_name=o2_qwen2_5_3b_text_sci_eval_text \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.project_name=o2_text_sci_clevr \
    trainer.experiment_name=o2_qwen2_5_3b_text_sci_clevr_eval_text \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.project_name=o2_text_sci_clevr \
    trainer.experiment_name=qwen2_5_3b_text_sci_clevr_eval_sci \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.project_name=o2_text_sci_clevr \
    trainer.experiment_name=o2_qwen3_8b_text_sci_eval_text \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.project_name=o2_text_sci_clevr \
    trainer.experiment_name=o2_qwen3_8b_text_sci_clevr_eval_text \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/rft.py:no_cot \
    trainer.project_name=o2_text_sci_clevr \
    trainer.experiment_name=o2_qwen3_8b_text_sci_clevr_eval_sci \
    data.format_prompt=./examples/format_prompt/no_cot.jinja \
    trainer.n_gpus_per_node=8 \
    data.image_key=images \
    worker.rollout.enforce_eager=false \
